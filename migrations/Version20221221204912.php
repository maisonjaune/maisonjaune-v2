...
final class Version20221221204912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE football_season (id INT AUTO_INCREMENT NOT NULL, championship_id INT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, year INT NOT NULL, actif TINYINT(1) NOT NULL, INDEX IDX_FCA4F86E94DDBCE9 (championship_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE football_season_team (season_id INT NOT NULL, team_id INT NOT NULL, INDEX IDX_42A93A814EC001D1 (season_id), INDEX IDX_42A93A81296CD8AE (team_id), PRIMARY KEY(season_id, team_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE football_season_team ADD CONSTRAINT FK_42A93A814EC001D1 FOREIGN KEY (season_id) REFERENCES football_season (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE football_season_team ADD CONSTRAINT FK_42A93A81296CD8AE FOREIGN KEY (team_id) REFERENCES football_team (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE football_season_team DROP FOREIGN KEY FK_42A93A814EC001D1');
        $this->addSql('ALTER TABLE football_season_team DROP FOREIGN KEY FK_42A93A81296CD8AE');
        ...
        $this->addSql('DROP TABLE football_season_team');
